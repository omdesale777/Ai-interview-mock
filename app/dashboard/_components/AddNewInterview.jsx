...
function AddNewInterview() {
    ...
    return (
        <div>
            <div style={{ border: '1px solid black' }} className='p-10 border rounded-lg bg-secondary hover:scale-105 hover:shadow-md cursor-pointer transition-all border-dashed'
